...
import { addRegisterData, selectSignUp } from "../redux/slices/signUpSlice";

export default function VideoPlayerSignIn({ handleClose, handleNumber }) {
  ...
  return (
    <div className=" rounded-[10px] md:w-[370px] w-[250px]">
      <div className="flex text-white rounded-t-[5px] bg-primary h-[80px] justify-center items-center">
        <div className="text-center flex flex-col w-full">
          <div className="flex justify-around mt-3">
            ...
            /> */}
            <span className="md:text-[18px] text-[14px] pl-2 font-bold"></span>
            <span className="md:text-[18px] text-[14px] pl-2 font-bold text-center ">
              Sign In
            </span>
            <p
              className="cursor-pointer text-[16px] font-bold ml-5"
              onClick={handleClose}
            >
              x
            </p>
          </div>
          <p className="md:text-[12px] text-[11px] pr-3 pl-3">
      ...
      <div className="bg-white pt-5 rounded-b-[10px]">
        <div className="flex flex-col gap-4 p-1 items-center ">
          <div className="h-10 px-2 border-b border-[#D0D5DD] lg:w-5/5 flex items-center text-lg w-full">
            <PhoneInput
              className="w-10"
            ...
            <input
              ...
              onChange={(e) =>
                dispatch(addRegisterData({ phonenumber: e.target.value }))
              }
          ...
          <button
            ...
            className="font-lg w-full ml-2 mr-2 px-2 py-2 text-white bg-primary border border-[#D0D5DD] rounded-[10px] active:opacity-75"
          >
            Continue
          </button>
        </div>
