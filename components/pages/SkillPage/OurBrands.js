    ...
    <div className="p-5 sm:p-10">
      <div>
        <p className="md:text-[45px] text-[25px] font-semibold text-center mb-5">
          Our Brand <span className="text-primary font-bold ">Partners </span>{" "}
          and <span className="text-primary font-bold ">Colleges </span>
        </p>
        <Carousel
          ref={carousel}
          showArrows={true}
        ...
        >
          {reviews?.map((item, index) => (
            <div
              key={index}
              className=" bg-white m-2  rounded-[10px] border-2 border-light-gray shadow-md"
            >
              <div className="  items-center">
                <div>
                  <img
                    className="w-full rounded-t-[10px] max-h-[180px] h-full"
