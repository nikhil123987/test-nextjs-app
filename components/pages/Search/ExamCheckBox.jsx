...
export default function ExamCheckbox({
  dropdownEffect = true,
  groupTitle,
  className,
  style,
  ...
  const handleChange = (e) => {
    ...
    setIndeterminate(!![e.target.value].length && [e.target.value].length < options.length)
    setCheckAll([e.target.value].length === [e.target.value].length)
