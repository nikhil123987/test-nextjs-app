...
export default function SignInDefault({ handleClose, handleGoogleSignIn }) {
  const dispatch = useDispatch();
  return (
    <div className=" rounded-[10px] md:w-[370px] w-[300px]">
      <div className="flex text-white rounded-t-[5px] bg-primary  justify-center items-center">
        <div className="text-center flex flex-col w-full">
          <div className="flex justify-between items-center mt-3">
            <span></span>
            <span className="text-[18px] font-bold">Get Started</span>
            <p
        ...
        <div className="flex flex-row items-center pb-5">
          ...
          >
            <span className="text-left">
              <img className="w-[20px] md:mr-10" src={google.src} alt="" />
            </span>
