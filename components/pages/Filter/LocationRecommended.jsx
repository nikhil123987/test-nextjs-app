...
const LocationRecommended = ({ name, content }) => {
  ...
  console.log(searchText, institutes);
        ...
        <div className="search relative">
          ...
          {searchText.length > 0 ? (
            <div className="absolute left-0 z-10 mt-2 w-56 origin-top-left rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none ">
              <div
                className="p-1 divide-y divide-gray/20 h-[300px] overflow-y-scroll"
                role="none"
              >
      ...
      <div className=" md:flex grid grid-cols-2 gap-2  items-center my-5">
        <div className="relative  my-1">
          <p
            ...
            className="flex w-full justify-between md:w-44 items-center  cursor-pointer border-4 border-solid border-primary  md:p-3  p-2"
          >
        ...
        <div className="relative  my-1">
          <p
            ...
            className="flex w-full justify-between  items-center  cursor-pointer border-2 border-solid border-light-gray  md:p-3 p-2"
          >
                    ...
                    return (
                      <div
                        ...
                        onClick={() => {
                          ...
                          const json = {};
                          filterByLocation(element.value);
                        }}
                      >
                        <p className={`  text-[16px]  px-4 py-2 `}>
                          {element.name}
        ...
        <div className="relative  my-1">
          <p
            ...
            className="flex w-full justify-between md:w-44 items-center  cursor-pointer border-2 border-solid border-light-gray  md:p-3 p-2 "
          >
            <p className={` text-[#000000] text-[16px] `}>
              {type
                ? type === 3
        ...
        <div className="relative">
          <p
            ...
            className="flex w-full justify-between items-center md:w-44 cursor-pointer border-2 border-solid border-light-gray  md:p-3 p-2"
          >
            <p className={` text-[#000000] text-[16px] `}>
